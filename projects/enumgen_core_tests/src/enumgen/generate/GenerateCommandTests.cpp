...
namespace enumgen::generate::tests
{
    ...
    TEST(GenerateCommandTests, parseGenerateCommand_WithDefaults)
    {
        // Arrange
        const auto args
            = createArgs({ "enumgen.exe"sv, "generate"sv, "-b"sv, "./path/to/binary"sv, "-s"sv, "./path/to/source"sv });
    ...
    TEST(GenerateCommandTests, parseCommand)
    {
        // Arrange
        const auto args = createArgs({ "enumgen.exe"sv,
                                       "generate"sv,
    ...
    TEST(GenerateCommandTests, parseCommand_WithDefaults)
    {
        // Arrange
        const auto args
            = createArgs({ "enumgen.exe"sv, "generate"sv, "-b"sv, "./path/to/binary"sv, "-s"sv, "./path/to/source"sv });
